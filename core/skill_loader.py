...
它保存就诊流程、预约确认要求和角色服务边界，通过显式重载更新后续请求。
"""
import json
import logging
...
class SkillManager:
    ...
    支持两种常用结构：
      1. skills/visit_guidance/SKILL.md
      2. skills/visit_guidance.json / skills/visit_guidance.md / skills/visit_guidance.txt
    """
