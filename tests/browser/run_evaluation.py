...
def run_once(url, output, timeout_seconds, expected_api="http://127.0.0.1:8010"):
    ...
    evidence = {
        ...
        "expected_api": expected_api, "request_method": "POST", "request_body": None,
        ...
        "baseline_check_scope": "host worktree data/eval/baseline.json only; container volume needs separate coordinator evidence",
...
if __name__ == "__main__":
    ...
    parser.add_argument("--expected-api", default="http://127.0.0.1:8010",
                        help="API behind the page proxy, as verified by the coordinator")
    ...
    if args.execute:
        ...
        run_once(args.url, destination, args.timeout_seconds, args.expected_api)
    else:
